...
} from '../../../Components/tables-common/BasicTablesCode';
				...
				<Row>
					...
					<Col xl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>table-striped</code> class to add zebra-striping to
									any table row within the &lt;tbody&gt;.
								</p>
								<div className='live-preview'>
									<div className='table-responsive'>
				...
				<Row>
					<Col lg={12}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>table-dark</code> class to set dark color table body
									and <code>table-success</code> class to set success color
									table body respectively. use <code>table-</code> class with
									different color variation to set required table body color.
								</p>
								<div className='live-preview'>
									<Row>
										<Col xl={6}>
				...
				<Row>
					<Col lg={12}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>table-hover</code> class to enable a hover state on
				...
				<Row>
					...
					<Col xl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>table-light</code> or <code>table-dark</code> class
									to create &lt;thead&gt; appear light or dark.
								</p>
								<div className='live-preview'>
									<div className='table-responsive'>
										<Table className='align-middle table-nowrap mb-0'>
				...
				<Row>
					...
					<Col xl={6}>
						<div className='card'>
							...
							<CardBody>
								<p className='text-muted'>
									You can also put the <code>&lt;caption&gt;</code> attribute on
									the top of the table with <code>caption-top</code> class.
								</p>
				...
				<Row>
					<Col xl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Example of basic table nesting. Border styles, active styles,
									and table variants are not inherited by nested tables.
								</p>
								<div className='live-preview'>
									<div className='table-responsive'>
										<Table className='table-nowrap mb-0'>
											...
											<tbody>
												<tr>
													...
													<td>
														...
														Use the vertical align classes to re-align where
														needed. inherit their alignment from and are aligned
														to the the top by default.
													</td>
												</tr>
												<tr className='align-bottom'>
													<td>
														This cell inherits{' '}
														<code>vertical-align: bottom;</code> from the table
														row
													</td>
													<td>
														This cell inherits{' '}
...
export default dynamic(() => Promise.resolve(BasicTables), { ssr: false });
