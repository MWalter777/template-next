...
const SimplePage = () => {
	...
	return (
		<Layout title='Profile | Velzon - React Admin & Dashboard Template'>
			<Container fluid>
											...
											<Card>
												<CardBody>
													...
													<p>
														...
														you’re working with reputable font websites. This
														may be the most commonly encountered tip I received
														from the designers I spoke with. They highly
														encourage that you use different fonts in one
																			...
																			<div className='accordion-item border-0'>
																				...
																				>
																					<div className='accordion-body ms-2 ps-5'>
																						...
																						I enjoy with my whole heart. Each
																						design is a new, unique piece of art
																						birthed into this world, and while
																			...
																			<div className='accordion-item border-0'>
																				...
																				>
																					<div className='accordion-body ms-2 ps-5 fst-italic'>
																						...
																						bootstrap 5 admin template. The
																						maximum file size for uploads in
																						this demo :
																						<Row className='mt-2'>
																							<Col xxl={6}>
																				...
																				>
																					<div className='accordion-body ms-2 ps-5'>
																						<p className='text-muted fst-italic mb-2'>
																							...
																							extremely well structured and uses
																							state of the art components (e.g.
																							one of the only templates using
