...
import {
	...
	InlineForms,
	FloatingLabels,
} from '../../../Components/forms-common/FormlayoutsCode';
				...
				<Row>
					...
					<Col lg={12}>
						<Card>
							...
							<div className='card-body'>
								<p className='text-muted'>
									Use <code>sm={`required size`}</code> size value to set column
...
export default dynamic(() => Promise.resolve(Formlayouts), { ssr: false });
