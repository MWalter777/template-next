...
import {
	...
	CustomStyles,
	SupportedElements,
} from '../../../Components/forms-common/FormValidationCode';
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									different style of feedback.While these feedback styles cannot
									be styled with CSS, you can still customize the feedback text
									through JavaScript.
								</p>
...
export default dynamic(() => Promise.resolve(FormValidations), { ssr: false });
