...
import {
	...
	RadioToggleButtons,
	OutlinedStyles,
} from '../../../Components/forms-common/CheckboxAndRadioCode';
									...
									<Row>
										<Col lg={4} md={6}>
											<div>
												...
												<p className='text-muted'>
													...
													checkbox and add <code>defaultChecked</code> attribute
													to set a checkbox checked by default.
												</p>
										...
										<Col lg={4} md={6}>
											<div className='mt-4 mt-md-0'>
												...
												<p className='text-muted'>
													Use <code>disabled</code> attribute to set a checkbox
													disabled and add <code>defaultChecked</code> attribute
													to set a checkbox checked by default.
												</p>
												<div>
										...
										<Col lg={4} md={6}>
											<div className='mt-4 mt-md-0'>
												...
												<p className='text-muted'>
													Use <code>form-check-right</code> class to form-check
													class to set a checkbox on the right side.
												</p>
												<div className='form-check form-check-right mb-2'>
													<Input
														className='form-check-input'
										...
										<Col md={6}>
											<div className='mt-4 mt-md-0'>
												<p className='text-muted'>
													...
													color variation to set a color checkbox with outline.
												</p>
									...
									<Row>
										<Col lg={4} md={6}>
											<div>
												...
												<p className='text-muted'>
													Use <code>type="radio"</code> attribute to set a radio
													button and add <code>defaultChecked</code> attribute
										...
										<Col lg={4} md={6}>
											<div className='mt-4 mt-md-0'>
												...
												<p className='text-muted'>
													Use <code>form-check-right</code> class to form-check
													class to set a radio button on the right side.
												</p>
												<div className='form-check form-check-right mb-2'>
													<Input
														className='form-check-input'
									...
									<Row>
										<Col md={6}>
											<div>
												<p className='text-muted'>
													Use <code>form-check-</code> class with
													below-mentioned color variation to set a color radio.
												</p>
									...
									<Row>
										<Col lg={4} md={6}>
											<div>
												...
												<p className='text-muted'>
													Use <code>form-switch</code> class to form-check class
													to set a switch and add <code>defaultChecked</code>{' '}
										...
										<Col lg={4} md={6}>
											<div className='mt-4 mt-md-0'>
												...
												<p className='text-muted'>
													Use <code>form-check-right</code> class to form-check
													class to set a switch button on the right side.
												</p>
												<div>
										...
										<Col lg={4} md={6}>
											<div className='mt-3'>
												...
												<p className='text-muted'>
													Use <code>form-switch-md</code> class to set a medium
													size switch button and
													<code>form-switch-lg</code> class to form-check class
													to set a large size switch button respectively. No
													such class is required for small size switch button.
												</p>
					...
					<div className='col-12'>
						<Card>
							...
							<div className='card-body'>
								<p className='text-muted'>
									Use <code>form-check-</code> class with below-mentioned color
									variation to set a color switch.
								</p>
								<div className='live-preview'>
									<Row>
										<Col md={6}>
				...
				<Row>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									<code>btn</code> styles rather than form-check-label class on
									the &lt;label&gt; elements. These toggle buttons can further
									be grouped in a{' '}
					...
					<Col lg={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Different variants of <code>btn</code> attribute, such as the
									various outlined styles, are supported.
								</p>
								<div className='live-preview'>
									<div className='hstack gap-2 flex-wrap'>
										<Input
...
export default dynamic(() => Promise.resolve(CheckBoxAndRadio), { ssr: false });
