...
const UiBadges = () => {
	return (
		<Layout title='Badges | Velzon - React Admin & Dashboard Template'>
			<UiContent />
			<Container fluid>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									below-mentioned variation to create a badge more rounded with
									a soft background.
								</p>
								<div className='live-preview'>
									<div className='d-flex flex-wrap gap-2'>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									with below mentioned modifier classes to make badges with
									border & soft backgorund.
								</p>
								<div className='live-preview'>
									<div className='d-flex flex-wrap gap-2'>
				...
				<Row>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									the below-mentioned variation to create a outline Pill badge.
								</p>
								<div className='live-preview'>
									<div className='d-flex flex-wrap gap-2'>
					...
					<Col xxl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use the <code>badge-label</code> class to create a badge with
									the label.
								</p>
