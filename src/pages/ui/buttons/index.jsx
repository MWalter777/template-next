...
} from '../../../Components/ui-common/UiButtonCode';
...
const UiButtons = () => {
	...
	return (
		<Layout title='Buttons | Velzon - React Admin & Dashboard Template'>
			<UiContent />
			<Container fluid>
				...
				<Row>
					<Col lg={12}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>data-bs-toggle="button"</code> to toggle a button’s
									active state.
								</p>
								<div className='live-preview'>
									<div className='d-flex flex-wrap gap-2'>
...
export default dynamic(() => Promise.resolve(UiButtons), { ssr: false });
