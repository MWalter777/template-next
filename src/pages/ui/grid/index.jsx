...
} from '../../../Components/ui-common/UiGridCode';
import Layout from '@/Layouts';

const UiGrid = () => {
	return (
		<Layout title='Grid | Velzon - React Admin & Dashboard Template'>
			<UiContent />
			<Container fluid>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									<code>align-self-center</code>, or <code>align-self-end</code>{' '}
									class respectively to vertically align items with a different
									position.
								</p>
