...
} from '../../../Components/UiAccordion&CollapseCode';
...
const UiAccordions = () => {
	...
	return (
		<Layout title='Accordions | Velzon - React Admin & Dashboard Template'>
			<UiContent />
			<Container fluid>
				...
				<Row>
					<Col xxl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>lefticon-accordion</code> class to show the icon on
														...
														<AccordionItem>
															...
															>
																<div className='accordion-body'>
																	...
																	them out of. If this user was to text to join
																	again, the initial text they are met with will
																	be a "welcome back" message instead of the
																	auto reply.
																</div>
															</Collapse>
														</AccordionItem>
				...
				<Row>
					<Col xl={12}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>accordion-fill-</code> class with modifier class to
									the color accordion.
								</p>
								<div className='live-preview'>
									<Row>
								...
								<div className='live-preview'>
									...
									<Collapse isOpen={coll1} id='collapseExample'>
										<div className='card mb-0'>
											<CardBody>
												When designing, the goal is to draw someone’s attention
												and portray to them what you’re trying to say. You can
												make a big statement by using little tricks, like this
												one. Use contrasting fonts. you can use a bold sanserif
												font with a cursive.
											</CardBody>
										</div>
									</Collapse>
									...
									<Collapse isOpen={coll6} id='collapseWithicon'>
										<div className='card mb-0'>
											<CardBody>
												...
												criteria, the search criteria is interpreted exactly as
												you entered it, and the search is case sensitive as a
												case insensitive search that contains certain text but
												does also provide a lot of search criteria options.
											</CardBody>
										</div>
									</Collapse>
									<Collapse isOpen={coll7} id='collapseWithicon2'>
										<div className='card mb-0 mt-3'>
											<CardBody>
												...
												names, addresses, or product groups, you enter criteria.
												In search criteria you can use all the numbers and
												letters that you normally use in the specific field. In
												addition, you can use special symbols to further filter
												the results.
											</CardBody>
										</div>
									</Collapse>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									and hide an element if they each reference it with their href
...
export default dynamic(() => Promise.resolve(UiAccordions), { ssr: false });
