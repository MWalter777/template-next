...
import {
	...
	PaginationExample,
	SpinnersExample,
} from '../../../Components/ui-common/UiGeneralCode';
									...
									<Row>
										...
										<Col lg={6}>
											<div className='mt-4 mt-lg-0'>
												...
												<p className='text-muted'>
													Use <code>disabled</code> attribute to PaginationItem
													to links that appear un-clickable and{' '}
										...
										<Col lg={6}>
											<div className='mt-4'>
												...
												<p className='text-muted'>
													...
													pagination class to change the alignment of pagination
													respectively.
												</p>
									...
									<Row>
										...
										<Col lg={6}>
											<div>
												...
												<p className='text-muted'>
													Use <code>spinner-grow</code> class for a lightweight
													spinner with growing effect.
												</p>
												<div className='d-flex flex-wrap gap-3 mb-2'>
													{/* <!-- Growing spinner --> */}
...
export default dynamic(() => Promise.resolve(UiGeneral), { ssr: false });
