...
} from '../../../Components/ui-common/UiProgressCode';
import Layout from '@/Layouts';
import dynamic from 'next/dynamic';

const UiProgress = () => {
	return (
		<Layout title='Placeholders'>
			<UiContent />
			<Container fluid>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>color="Required Color"</code> attribute to progress
									bar class with the below-mentioned color variation to set the
				...
				<Row>
					...
					<Col xxl={6}>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>striped animated</code> attribute to add strip with
									animation to the progress.
								</p>
				...
				<Row>
					...
					<Col xxl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>animated-progess</code> class to show progress with
									animation.
								</p>
								<div className='live-preview'>
									<div className='mb-4'>
									...
									<Card className='bg-light overflow-hidden shadow-none'>
										...
										<div>
											<Progress
												value={30}
												color='secondary'
												className='bg-soft-secondary rounded-0'
											/>
										</div>
									</Card>
...
export default dynamic(() => Promise.resolve(UiProgress), { ssr: false });
