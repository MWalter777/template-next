...
import {
	...
	ListNumberedExample,
	CustomListExample,
} from '../../../Components/ui-common/UiListCode';
				...
				<Row>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>ListGroup</code> attribute in an unordered list and{' '}
									<code>ListGroupItem</code> attribute to create a default list
									group.
								</p>
					...
					<Col xxl={4} xl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>tag="a"</code> to create actionable list group items
					...
					<Col xxl={4} xl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>tag="button"</code> to create actionable list group
				...
				<Row>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									addition of the hover styles here not present in the previous
									example.
								</p>
								<div className='live-preview'>
									<ListGroup>
					...
					<Col xxl={4} xl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>list-group-fill-</code> with modifier class to style
				...
				<Row>
					...
					<Col xxl={4} xl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>list-group-numbered</code> class (optionally use an{' '}
									<code>&lt;ol&gt;</code> element) to show numbered list group
									items.{' '}
								</p>
								<div className='live-preview'>
...
export default dynamic(() => Promise.resolve(UiList), { ssr: false });
