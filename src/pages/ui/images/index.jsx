...
import {
	...
	FiguresExample,
	ResponsiveExample,
} from '../../../Components/ui-common/UiImagesCode';
...
const UiImages = () => {
	return (
		<Layout title='Images | Velzon - React Admin & Dashboard Template'>
			<UiContent />
			<Container fluid>
				...
				<Row>
					...
					<Col xxl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>img-thumbnail</code> class to give an image rounded
					...
					<Col xl={4}>
						<Card>
							...
							<CardBody>
								...
								<div className='live-preview'>
									<div>
										<Image src={img2} className='img-fluid' alt='Responsive' />
									</div>
								</div>
...
export default dynamic(() => Promise.resolve(UiImages), { ssr: false });
