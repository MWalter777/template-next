...
import {
	...
	WidthExample,
	HeightExample,
} from '../../../Components/ui-common/UiUtilitiesCode';
				...
				<Row>
					<Col lg={12}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use the below-mentioned class to an element to custom display
									the value of components and more with our display utilities.
								</p>
								<div className='live-preview'>
									<div>
										<div className='table-responsive'>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted mb-3'>
									...
									Stacked items are full-width by default. Use <code>gap-</code>{' '}
									class with variation to add space between items.
								</p>
								<div className='live-preview'>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted mb-3'>
									...
									, or <code>user-select-none</code> class to the content which
												...
												<div className='mt-4 mt-xl-0'>
													...
													<div className='d-md-flex bg-light'>
														...
														>
															...
															set width and height dimensions. Lorem ipsum dolor
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									Bootstrap and can be enabled via <code>$enable-shadows</code>,
...
export default dynamic(() => Promise.resolve(UiUtilities), { ssr: false });
