				...
				<Row>
					<Col xxl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>w-25,w-50,w-75</code> or <code>w-100</code> class to
									placeholder class to set different widths to the placeholder.
								</p>
								<div className='live-preview'>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									or <code>placeholder-xs</code> class to placeholder class to
									set different size placeholder.
								</p>
								<div className='live-preview'>
									<Row className='gap-0'>
