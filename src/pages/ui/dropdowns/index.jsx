...
} from '../../../Components/ui-common/UiDropdownsCode';
...
const UiDropdowns = () => {
	...
	return (
		<Layout title='Dropdowns | Velzon - React Admin & Dashboard Template'>
			<UiContent />
			<Container fluid>
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>btn-</code> class with below mentioned variation to
				...
				<Row>
					<Col lg={12}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>btn-lg</code> class to create a large size dropdown
									button and <code>btn-sm</code> to create a small size dropdown
									button.
								</p>
								<div className='live-preview'>
...
export default dynamic(() => Promise.resolve(UiDropdowns), { ssr: false });
