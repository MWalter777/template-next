...
import {
	...
	SolidAlertsExample,
} from '../../../Components/alerts/UiAlertsCode';

const UiAlerts = () => {
	const [show, setShow] = useState(false);

	return (
		<Layout title='Alerts | Velzon - React Admin & Dashboard Template'>
			<UiContent />
				...
				<Row>
					<Col lg={12}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use the <code>alert-link</code> class at &lt;a&gt; tag to show
									matching colored links within the given alert.
								</p>
				...
				<Row>
					<Col lg={12}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use the <code>alert-outline</code> class to set an alert with
									outline.
								</p>
				...
				<Row>
					<Col lg={12}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use the <code>alert-border-left </code> class to set an alert
									...
									<Row>
										...
										<Col xl={6}>
											...
											<Alert color='dark' className='alert-solid mb-0'>
												<strong>Did you know?</strong> - Solid <b>dark alert</b>{' '}
												example
											</Alert>
										</Col>
									</Row>
...
export default dynamic(() => Promise.resolve(UiAlerts), { ssr: false });
