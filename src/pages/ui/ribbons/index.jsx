...
import {
	...
	RibbonsExample,
	RibbonsHoverExample,
} from '../../../Components/ui-common/UiRibbonsCode';
						...
						<Card>
							...
							<CardBody>
								<div className='live-preview'>
									<Row className='g-3'>
										<p className='text-muted'>
											Use <code>ribbon-shape</code> class to show ribbon shaped
											ribbon.
										</p>
										<Col xxl={4}>
											<div className='card ribbon-box border shadow-none mb-lg-0'>
											...
											<div className='card ribbon-box border shadow-none mb-lg-0'>
												<div className='card-body text-muted'>
													...
													<p className='mb-0'>
														...
														Nulla sapien mauris, eleifend et sem ac, commodo
						...
						<Card>
							...
							<CardBody>
								<div className='live-preview'>
									<Row className='g-3'>
										<p className='text-muted'>
											Use <code>trending-ribbon</code> class to show ribbon with
											hovering effect.
										</p>
										<Col xxl={4}>
...
export default dynamic(() => Promise.resolve(UiRibbons), { ssr: false });
