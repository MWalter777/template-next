...
import {
	...
	VisibilityExample,
	ClearfixExample,
} from '../../../Components/ui-common/UiTypographyCode';
						...
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									...
									class for quoting blocks of content from another source within
									your document .
								</p>
						...
						<Card>
							...
							<CardBody>
								<div className='live-preview'>
									<div>
										<p className='text-muted'>
											Use <code>text-break</code> class to prevent long strings
											of text from breaking your components' layout.
										</p>
				...
				<Row>
					<Col xxl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>fst-</code>with modifier class to change font-style
									and Use <code>fw-</code>with modifier class to change
									font-weight.
								</p>
				...
				<Row>
					<Col xxl={6}>
						<Card>
							...
							<CardBody>
								<p className='text-muted'>
									Use <code>text-truncate</code> class to truncate the text with
...
export default dynamic(() => Promise.resolve(UiTypography), { ssr: false });
